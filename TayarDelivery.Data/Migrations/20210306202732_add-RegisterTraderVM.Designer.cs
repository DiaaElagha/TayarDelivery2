...
namespace TayarDelivery.Data.Migrations
{
    ...
    [Migration("20210306202732_add-RegisterTraderVM")]
    partial class addRegisterTraderVM
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.BillTahsil", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.Home.HomeInfo", b =>
                {
                    ...
                    b.Property<string>("BackgroundImageHeight")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BackgroundImageWidth")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("MainTitleColor")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.Link", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.LookUp.AreasPrice", b =>
                {
                    ...
                    b.Property<float?>("DiscountPriceWhenReturn")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.LookUp.CompanyInformation", b =>
                {
                    ...
                    b.Property<string>("LicensedNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.Order", b =>
                {
                    ...
                    b.Property<bool>("DriverApprovalStatus")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("IsIncludeDeliveryPrice")
                        .HasColumnType("bit");

                    b.Property<bool>("IsSetDriver")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.RoleLinks", b =>
                {
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.RolesUser", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.Link", b =>
                {
                    ...
                    b.HasOne("TayarDelivery.Entity.Domins.Link", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.Notification.Notification", b =>
                {
                    b.HasOne("TayarDelivery.Entity.Domins.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.Order", b =>
                {
                    ...
                    b.HasOne("TayarDelivery.Entity.Domins.LookUp.Area", "AreaSender")
                        .WithMany()
                        .HasForeignKey("AreaIdSender");
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.RoleLinks", b =>
                {
                    b.HasOne("TayarDelivery.Entity.Domins.Link", "Link")
                        .WithMany()
                        .HasForeignKey("LinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TayarDelivery.Entity.Domins.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TayarDelivery.Entity.Domins.RolesUser", b =>
                {
                    ...
                    b.HasOne("TayarDelivery.Entity.Domins.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
